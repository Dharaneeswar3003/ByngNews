...
function renderHomePage(container) {
    container.innerHTML = `
        <section>
            <div class="article-container" id="home-articles">
            </div>
        </section>
        <br>
        ...
        <section>
            <div class="main-contact">
                <h2>Contact</h2>
                <p>Inquiries can be sent to our team via <a href="mailto:" target="_blank">email</a>, or through a direct message via <a href="https://www.instagram.com/byngnewspaperclub/" target="_blank">Instagram</a>.<br>
        ...
        <section>
            <div class="about">
                ...
                <section class="team-member">
                    <div class="image-container">
                        <img src="Charlie.jpeg" alt="Charlie Chen" width="300">
                    </div>
                    <br>
                    <div class="member-info">
                        <h3><strong>Charlie Chen</strong></h3>
                        <h2>Director</h2>
                        <p>I facilitate regular meetings to address progress, challenges, and plans while overseeing the schedule of events and assigning tasks. I also create presentations to guide the team and foster a positive environment to keep the publication on track.</p>
                    </div>
                </section>
                <hr>
                <!-- Team Member: Dharaneeswar -->
                <section class="team-member">
                    <div class="image-container">
                        <img src="DD.png" alt="Dharaneeswar Dadibathina" width="300">
                    </div>
                    <br>
                    <div class="member-info">
                        <h3><strong>Dharaneeswar Dadibathina</strong></h3>
                        <h2>Web Design and Layout</h2>
                        <p>I design, develop, and maintain the online platform for the newspaper, ensuring it is user-friendly, visually appealing, and up-to-date. I troubleshoot technical issues, provide timely solutions, and ensure the website is secure and compliant with relevant regulations. </p>
                    </div>
                </section>
                <hr>
                <!-- Team Member: Julian -->
                <section class="team-member">
                    <div class="image-container">
                        <img src="Julian.jpeg" alt="Julian Cohen Wood" width="300">
                    </div>
                    <br>
                    <div class="member-info">
                ...
                <section class="team-member">
                    <div class="image-container">
                        <img src="Leo.jpeg" alt="Leo Ke" width="300">
                    </div>
                    <br>
                    <div class="member-info">
                ...
                <section class="team-member">
                    <div class="image-container">
                        <img src="Lucca.jpeg" alt="Lucca Ha" width="300">
                    </div>
                    <br>
                    <div class="member-info">
...
function renderContactPage(container) {
    container.innerHTML = `
        <section>
            <div class="contact">
                <h2>Contact Us</h2><br>
                <p>Inquiries can be sent to our team via <a href="mailto:byngnewspaperclub@gmail.com">email</a>, or through a direct message via <a href = "https://www.instagram.com/byngnewspaperclub/" target =_blank>Instagram</a>.<br>
                <br>If you have an idea for an article, topic, or story, a suggestion for an article or another piece you'd like to contribute, or a comment or question, Phantom Press would like to hear from you!</p>
            </div>
        </section>
    `;
...
function loadContent(page) {
    ...
    // Show or hide the home image container based on the page
    if (page === 'home') {
        homeImageContainer.classList.remove('hidden');
    } else {
    ...
    switch (page) {
        ...
        case 'news':
            ...
            break;
        case 'features':
            renderFeaturesPage(container);
            break;
        case 'allarticles':
            renderAllArticlesPage(container);
            break;
        case 'home':
        default:
